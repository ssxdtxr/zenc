...
3а. Для каждой подтемы составь 2–4 ключевых определения терминов, специфичных именно для этой подтемы
  ...
  "subtopics": [
    {
      ...
      "definitions": [
        { "term": "ключевой термин подтемы", "definition": "точное экспертное определение" }
      ]
    }
  ],
