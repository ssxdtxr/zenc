      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 860, margin: "0 auto", padding: "22px 28px 80px" }}>
        ...
        {!loadingTheory && (
          <div style={{ marginTop: 24, display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            <button onClick={() => router.push(`/topic/${topicId}/subtopic/${encodeURIComponent(subtopicName)}/test`)} style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 20px", borderRadius: 14, border: "1px solid rgba(155,107,255,0.35)", cursor: "pointer", background: "rgba(155,107,255,0.08)", color: "#c4adff", fontWeight: 600, fontSize: 15, fontFamily: "inherit" }}>
              Теоретический тест →
            </button>
          </div>
        )}
