  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", background: BG, overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1040, margin: "0 auto", padding: "22px 28px 80px" }}>
        ...
        {/* NAV */}
        <nav style={{ display: "flex", alignItems: "center", gap: 16, padding: "11px 16px", borderRadius: 20, background: "rgba(var(--fg-rgb),0.06)", backdropFilter: "blur(24px) saturate(150%)", WebkitBackdropFilter: "blur(24px) saturate(150%)", border: "1px solid rgba(var(--fg-rgb),0.12)", boxShadow: "0 10px 40px rgba(var(--shadow-rgb),0.45), inset 0 1px 0 rgba(var(--fg-rgb),0.18)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
            {exercises.length > 0 && (
              <span style={{ fontSize: 13, fontWeight: 600, color: "rgba(var(--fg-rgb),0.5)" }}>{doneCount}/{exercises.length}</span>
            )}
            {statusCfg && (
        ...
        {loadingTheory && (
          <div style={{ paddingTop: 80, display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
            ...
            <p style={{ margin: 0, fontSize: 14, color: "rgba(var(--fg-rgb),0.5)", fontWeight: 500 }}>Загружаю задания…</p>
        ...
        {allDone && (
          <motion.div initial={{ opacity: 0, y: 12, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ type: "spring", stiffness: 300, damping: 28 }} style={{ marginTop: 20, padding: "24px 26px", borderRadius: 22, background: avgScore >= 80 ? "linear-gradient(135deg,rgba(94,224,138,0.15),rgba(43,217,227,0.06))" : avgScore >= 50 ? "linear-gradient(135deg,rgba(255,187,92,0.15),rgba(255,150,50,0.05))" : "linear-gradient(135deg,rgba(255,126,146,0.12),rgba(255,80,80,0.04))", border: `1px solid ${avgScore >= 80 ? "rgba(94,224,138,0.3)" : avgScore >= 50 ? "rgba(255,187,92,0.3)" : "rgba(255,126,146,0.3)"}`, backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)" }}>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.08em", color: "rgba(var(--fg-rgb),0.4)", marginBottom: 8 }}>ИТОГ ПРАКТИКИ</div>
                    ...
                    {!s?.result ? (
                      <>
                        <textarea
                          ...
                          rows={6}
                          style={{ width: "100%", resize: "vertical", padding: "14px 16px", borderRadius: 14, background: "rgba(var(--fg-rgb),0.04)", border: `1.5px solid ${s?.answer ? "rgba(155,107,255,0.4)" : "rgba(var(--fg-rgb),0.1)"}`, outline: "none", color: "var(--text)", fontSize: 13.5, lineHeight: 1.65, fontFamily: "var(--font-mono, monospace)", boxSizing: "border-box" }}
                        />
